...
const CardBack: React.FC<CardBackProps> = ({ watch, className, cvc, ...cardFrontProps }) => {
    return (
        <div className={` flex absolute bottom-4 lg:top-auto lg:bottom-1/3 xl:bottom-1/4 2xl:bottom-1/3  lg:-right-32 2xl:left-auto 2xl:-right-28 left-1/3 top-2 shadow-md text-white flex-col bg-gray-200 rounded-lg ${RESPONSIVE_CARD} ${className}`
        }>
