...
const CardBack: React.FC<CardBackProps> = ({ watch, className, cvc, ...cardFrontProps }) => {
    return (
        <div className={`${RESPONSIVE_CARD} ${BASE_CARD} flex absolute bottom-4 lg:top-auto lg:bottom-1/3 xl:bottom-1/4 2xl:bottom-1/3  lg:-right-32 2xl:left-auto 2xl:-right-28 left-1/3 top-2   flex-col bg-gray-200   ${className}`
        }>
